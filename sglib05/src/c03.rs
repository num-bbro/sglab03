...
impl PeaAssVar {
    pub fn _a(&self, s: &str) {
        let c = self.chk();
        if !c.is_empty() {
            print!(" {s}:{c}");
        }
    }
    pub fn chk(&self) -> String {
        use std::fmt::Write;
        let mut c = String::from("");
        if self.vp01 != self.v[VarType::NewCarRegVp01 as usize].v {
            write!(c, " p01").unwrap();
        }
        if self.vp02 != self.v[VarType::GppVp02 as usize].v {
            write!(c, " p02").unwrap();
        }
        if self.vs01 != self.v[VarType::MaxPosPowSubVs01 as usize].v {
            write!(c, " s01").unwrap();
        }
        if self.vs02 != self.v[VarType::MaxNegPowSubVs02 as usize].v {
            write!(c, " s02").unwrap();
        }
        if self.vs03 != self.v[VarType::VsppMvVs03 as usize].v {
            write!(c, " s03").unwrap();
        }
        if self.vs04 != self.v[VarType::SppHvVs04 as usize].v {
            write!(c, " s04").unwrap();
        }
        if self.vs05 != self.v[VarType::BigLotMvVs05 as usize].v {
            write!(c, " s05").unwrap();
        }
        if self.vs06 != self.v[VarType::BigLotHvVs06 as usize].v {
            write!(c, " s06").unwrap();
        }
        if self.vs07 != self.v[VarType::SubPowCapVs07 as usize].v {
            write!(c, " s07").unwrap();
        }
        if self.vf01 != self.v[VarType::MaxPosPowFeederVf01 as usize].v {
            write!(c, " f01").unwrap();
        }
        if self.vf02 != self.v[VarType::MaxNegPowFeederVf02 as usize].v {
            write!(c, " f02").unwrap();
        }
        if self.vf03 != self.v[VarType::MaxPosDiffFeederVf03 as usize].v {
            write!(c, " f03").unwrap();
        }
        if self.vf04 != self.v[VarType::MaxNegDiffFeederVf04 as usize].v {
            write!(c, " f04").unwrap();
        }
        if self.vt01 != self.v[VarType::NoMeterTransVt01 as usize].v {
            write!(c, " t01").unwrap();
        }
        if self.vt02 != self.v[VarType::SmallSellTrVt02 as usize].v {
            write!(c, " t02").unwrap();
        }
        if self.vt03 != self.v[VarType::ChgStnCapTrVt03 as usize].v {
            write!(c, " t03").unwrap();
        }
        if self.vt04 != self.v[VarType::ChgStnSellTrVt04 as usize].v {
            write!(c, " t04").unwrap();
        }
        if self.vt05 != self.v[VarType::PwCapTriVt05 as usize].v {
            write!(c, " t05").unwrap();
        }
        if self.vt06 != self.v[VarType::ZoneTrVt06 as usize].v {
            write!(c, " t06").unwrap();
        }
        if self.vt07 != self.v[VarType::PopTrVt07 as usize].v {
            write!(c, " t07").unwrap();
        }
        if self.vt08 != self.v[VarType::UnbalPowTrVt08 as usize].v {
            write!(c, " t08").unwrap();
        }
        if self.vt09 != self.v[VarType::PkPowTrVt09 as usize].v {
            write!(c, " t09").unwrap();
        }
        if self.vt10 != self.v[VarType::LargeSellTrVt10 as usize].v {
            write!(c, " t10").unwrap();
        }
        if self.vt11 != self.v[VarType::AllNoMeterTrVt11 as usize].v {
            write!(c, " t11").unwrap();
        }
        if self.vt12 != self.v[VarType::NoTrVt12 as usize].v {
            write!(c, " t12").unwrap();
        }
        if self.vc01 != self.v[VarType::NoHmChgEvTrVc01 as usize].v {
            write!(c, " c01").unwrap();
        }
        if self.vc02 != self.v[VarType::LvPowSatTrVc02 as usize].v {
            write!(c, " c02").unwrap();
        }
        if self.vc03 != self.v[VarType::CntLvPowSatTrVc03 as usize].v {
            write!(c, " c03").unwrap();
        }
        if self.vc04 != self.v[VarType::ChgStnCapVc04 as usize].v {
            write!(c, " c04").unwrap();
        }
        if self.vc05 != self.v[VarType::ChgStnSellVc05 as usize].v {
            write!(c, " c05").unwrap();
        }
        if self.vc06 != self.v[VarType::MvPowSatTrVc06 as usize].v {
            write!(c, " c06").unwrap();
        }
        if self.vc07 != self.v[VarType::PowSolarVc07 as usize].v {
            write!(c, " c07").unwrap();
        }
        if self.vc08 != self.v[VarType::MvVsppVc08 as usize].v {
            write!(c, " c08").unwrap();
        }
        if self.vc09 != self.v[VarType::HvSppVc09 as usize].v {
            write!(c, " c09").unwrap();
        }
        if self.vc10 != self.v[VarType::SmallSellVc10 as usize].v {
            write!(c, " c10").unwrap();
        }
        if self.vc11 != self.v[VarType::LargeSellVc11 as usize].v {
            write!(c, " c11").unwrap();
        }
        if self.vc12 != self.v[VarType::UnbalPowVc12 as usize].v {
            write!(c, " c12").unwrap();
        }
        if self.vc13 != self.v[VarType::CntUnbalPowVc13 as usize].v {
            write!(c, " c13").unwrap();
        }
        if self.vc14 != self.v[VarType::Uc1ValVc14 as usize].v {
            write!(c, " c14").unwrap();
        }
        if self.vc15 != self.v[VarType::Uc2ValVc15 as usize].v {
            write!(c, " c15").unwrap();
        }
        if self.vc16 != self.v[VarType::Uc3ValVc16 as usize].v {
            write!(c, " c16").unwrap();
        }
        if self.sum != self.res {
            write!(c, " res").unwrap();
        }
        c
    }
    ...
    pub fn nor(&mut self, o: &PeaAssVar) {
        if self.v[VarType::NewCarRegVp01 as usize].v != self.vp01 {
            print!(" VP01");
        } else if o.v[VarType::NewCarRegVp01 as usize].v != o.vp01 {
            print!(" MX01");
        }
        ...
        self.vc13 /= z2o(o.vc13);
        self.vc14 /= z2o(o.vc14);
        self.vc15 /= z2o(o.vc15);
        self.vc16 /= z2o(o.vc16);
    }
    ...
    pub fn max(&mut self, o: &PeaAssVar) {
        ...
        self.vc13 = self.vc13.max(o.vc13);
        self.vc14 = self.vc14.max(o.vc14);
        self.vc15 = self.vc15.max(o.vc15);
        self.vc16 = self.vc16.max(o.vc16);
    }
    pub fn min(&mut self, o: &PeaAssVar) {
        ...
        self.vc13 = self.vc13.min(o.vc13);
        self.vc14 = self.vc14.min(o.vc14);
        self.vc15 = self.vc15.min(o.vc15);
        self.vc16 = self.vc16.min(o.vc16);
    }
...
impl PeaAssVar {
    pub fn from(n1d: u64) -> Self {
        let v = vec![
            AssVar::new(VarType::None, SumType::Sum),
            AssVar::new(VarType::NewCarRegVp01, SumType::Sum),
            AssVar::new(VarType::GppVp02, SumType::Sum),
            AssVar::new(VarType::MaxPosPowSubVs01, SumType::Max),
            AssVar::new(VarType::MaxNegPowSubVs02, SumType::Max),
            AssVar::new(VarType::VsppMvVs03, SumType::Sum),
            AssVar::new(VarType::SppHvVs04, SumType::Sum),
            AssVar::new(VarType::BigLotMvVs05, SumType::Sum),
            AssVar::new(VarType::BigLotHvVs06, SumType::Sum),
            AssVar::new(VarType::SubPowCapVs07, SumType::Sum),
            AssVar::new(VarType::MaxPosPowFeederVf01, SumType::Max),
            AssVar::new(VarType::MaxNegPowFeederVf02, SumType::Max),
            AssVar::new(VarType::MaxPosDiffFeederVf03, SumType::Max),
            AssVar::new(VarType::MaxNegDiffFeederVf04, SumType::Max),
            AssVar::new(VarType::NoMeterTransVt01, SumType::Sum),
            AssVar::new(VarType::SmallSellTrVt02, SumType::Sum),
            AssVar::new(VarType::ChgStnCapTrVt03, SumType::Sum),
            AssVar::new(VarType::ChgStnSellTrVt04, SumType::Sum),
            AssVar::new(VarType::PwCapTriVt05, SumType::Sum),
            AssVar::new(VarType::ZoneTrVt06, SumType::Sum),
            AssVar::new(VarType::PopTrVt07, SumType::Sum),
            AssVar::new(VarType::UnbalPowTrVt08, SumType::Sum),
            AssVar::new(VarType::PkPowTrVt09, SumType::Sum),
            AssVar::new(VarType::LargeSellTrVt10, SumType::Sum),
            AssVar::new(VarType::AllNoMeterTrVt11, SumType::Sum),
            AssVar::new(VarType::NoTrVt12, SumType::Sum),
            AssVar::new(VarType::NoHmChgEvTrVc01, SumType::Sum),
            AssVar::new(VarType::PowHmChgEvTr, SumType::Sum),
            AssVar::new(VarType::LvPowSatTrVc02, SumType::Sum),
            AssVar::new(VarType::CntLvPowSatTrVc03, SumType::Sum),
            AssVar::new(VarType::ChgStnCapVc04, SumType::Sum),
            AssVar::new(VarType::ChgStnSellVc05, SumType::Sum),
            AssVar::new(VarType::MvPowSatTrVc06, SumType::Sum),
            AssVar::new(VarType::PowSolarVc07, SumType::Sum),
            AssVar::new(VarType::MvVsppVc08, SumType::Sum),
            AssVar::new(VarType::HvSppVc09, SumType::Sum),
            AssVar::new(VarType::SmallSellVc10, SumType::Sum),
            AssVar::new(VarType::LargeSellVc11, SumType::Sum),
            AssVar::new(VarType::UnbalPowVc12, SumType::Sum),
            AssVar::new(VarType::CntUnbalPowVc13, SumType::Sum),
            AssVar::new(VarType::Uc1ValVc14, SumType::Sum),
            AssVar::new(VarType::Uc2ValVc15, SumType::Sum),
            AssVar::new(VarType::Uc3ValVc16, SumType::Sum),
        ];
        PeaAssVar {
            n1d,
            v,
...
pub fn c01_chk_02() -> Result<(), Box<dyn Error>> {
    ...
    chk_02_2(&aids, &pea, dnm, &tras_mx1, &mut tras_mx2)?;
    chk_02_3(&aids, &pea, dnm, &tras_mx2)?;
    Ok(())
}
            ...
            for sid in sids {
                ...
                for fid in fids {
                    ...
                    for tid in tids {
                        ...
                        /*
                        tr_as.v[VarType::NoHmChgEvTrVc01 as usize].v = vc01;
                        tr_as.v[VarType::PowHmChgEvTr as usize].v = 0f32;
                        tr_as.v[VarType::LvPowSatTrVc02 as usize].v = vc02;
                        tr_as.v[VarType::CntLvPowSatTrVc03 as usize].v = vc03;
                        tr_as.v[VarType::ChgStnCapVc04 as usize].v = vc04;
                        tr_as.v[VarType::ChgStnSellVc05 as usize].v = vc05;
                        tr_as.v[VarType::MvPowSatTrVc06 as usize].v = vc06;
                        tr_as.v[VarType::PowSolarVc07 as usize].v = vc07;
                        tr_as.v[VarType::MvVsppVc08 as usize].v = vc08;
                        tr_as.v[VarType::HvSppVc09 as usize].v = vc09;
                        tr_as.v[VarType::SmallSellVc10 as usize].v = vc10;
                        tr_as.v[VarType::LargeSellVc11 as usize].v = vc11;
                        tr_as.v[VarType::UnbalPowVc12 as usize].v = vc12;
                        tr_as.v[VarType::CntUnbalPowVc13 as usize].v = vc13;
                        tr_as.v[VarType::Uc1ValVc14 as usize].v = vc14;
                        tr_as.v[VarType::Uc2ValVc15 as usize].v = vc15;
                        tr_as.v[VarType::Uc3ValVc16 as usize].v = vc16;
                        */
                ...
                let a = write_trn_ass_01(&s_tr_ass, &format!("{dnm}/{sid}-raw.txt"))?;
                let b = write_trn_ass_010(&s_tr_ass, &format!("{dnm}/{sid}-raw0.txt"))?;
                println!("=====================================  {}", a == b);
                let bin: Vec<u8> =
...
pub fn chk_02_2(
    ...
    */
    let mut evwe = PeaAssVar::from(0u64);
    evwe.vp01 = 0.20;
    evwe.vp02 = 0.05;
    evwe.vt01 = 0.20;
    evwe.vt02 = 0.15;
    ...
    evwe.v[VarType::NewCarRegVp01 as usize].v = 0.20;
    evwe.v[VarType::GppVp02 as usize].v = 0.05;
    evwe.v[VarType::NoMeterTransVt01 as usize].v = 0.20;
    evwe.v[VarType::SmallSellTrVt02 as usize].v = 0.15;
    evwe.v[VarType::ChgStnCapTrVt03 as usize].v = 0.15;
    evwe.v[VarType::ChgStnSellTrVt04 as usize].v = 0.05;
    evwe.v[VarType::PwCapTriVt05 as usize].v = 0.10;
    evwe.v[VarType::ZoneTrVt06 as usize].v = 0.05;
    evwe.v[VarType::PopTrVt07 as usize].v = 0.05;
    ...
    */
    let mut sowe = PeaAssVar::from(0u64);

    sowe.v[VarType::GppVp02 as usize].v = 0.10;
    sowe.v[VarType::MaxPosPowSubVs01 as usize].v = 0.02;
    sowe.v[VarType::MaxNegPowSubVs02 as usize].v = 0.02;
    sowe.v[VarType::VsppMvVs03 as usize].v = 0.02;
    sowe.v[VarType::SppHvVs04 as usize].v = 0.02;
    sowe.v[VarType::BigLotMvVs05 as usize].v = 0.02;
    sowe.v[VarType::MaxNegPowFeederVf02 as usize].v = 0.05;
    sowe.v[VarType::MaxPosDiffFeederVf03 as usize].v = 0.05;
    sowe.v[VarType::NoMeterTransVt01 as usize].v = 0.20;
    sowe.v[VarType::SmallSellTrVt02 as usize].v = 0.20;
    sowe.v[VarType::PwCapTriVt05 as usize].v = 0.20;
    sowe.v[VarType::ZoneTrVt06 as usize].v = 0.05;
    sowe.v[VarType::PopTrVt07 as usize].v = 0.05;
    ...
    for id in aids {
        ...
        for pid in pids {
            ...
            for sid in sids {
                ...
                let b = write_trn_ass_010(&v_tras_nor, &format!("{dnm}/{sid}-nor0.txt"))?;
                println!("=====================================  {}", a == b);
                ...
                for (tras, tras0) in v_tras_ev.iter_mut().zip(v_tras_raw.iter_mut()) {
                    ...
                    tras._a("v:");
                    tras0.vc01 = tras.sum;
                    tras0.v[VarType::NoHmChgEvTrVc01 as usize].v = tras.res;
                    tras0._a("w:");
                }
                //// save ev bin
                let bin: Vec<u8> =
                ...
                let b = write_trn_ass_010(&v_tras_ev, &format!("{dnm}/{sid}-ev0.txt"))?;
                println!("=====================================  {}", a == b);
                ...
                let a = write_trn_ass_01(&v_tras_ev, &format!("{dnm}/{sid}-so.txt"))?;
                let b = write_trn_ass_010(&v_tras_ev, &format!("{dnm}/{sid}-so0.txt"))?;
                println!("=====================================  {}", a == b);
                ...
                for tr in v_tras_raw.iter_mut() {
                    ...
                    tr.vc11 = tr.vt10;
                    tr.vc12 = tr.vt08;
                    let v = tr.vt08 / z2o(tr.vt05);
                    tr.vc13 = if v > 0.5f32 { 1f32 } else { 0f32 };
                    ...
                    tr.v[VarType::CntLvPowSatTrVc03 as usize].v =
                        if tr.v[VarType::LvPowSatTrVc02 as usize].v > 0.5f32 {
                            1f32
                        } else {
                            0f32
                        };
                ...
                let a = write_trn_ass_01(&v_tras_raw, &format!("{dnm}/{sid}-rw2.txt"))?;
                let b = write_trn_ass_010(&v_tras_raw, &format!("{dnm}/{sid}-rw20.txt"))?;
                println!("=====================================  {}", a == b);
            } // end sub loop
        } // end provi loop
    } // end area
...
pub fn chk_02_3(
    ...
    */
    ...
    let mut uc1 = PeaAssVar::from(0u64);
    uc1.vt02 = 0.10;
    uc1.vt10 = 0.05;
    uc1.vc01 = 0.15;
    uc1.vc03 = 0.15;
    ...
    uc1.vc12 = 0.10;
    uc1.vc13 = 0.05;
    uc1.v[VarType::SmallSellTrVt02 as usize].v = 0.10;
    uc1.v[VarType::LargeSellTrVt10 as usize].v = 0.05;
    uc1.v[VarType::NoHmChgEvTrVc01 as usize].v = 0.15;
    uc1.v[VarType::CntLvPowSatTrVc03 as usize].v = 0.15;
    uc1.v[VarType::ChgStnCapVc04 as usize].v = 0.05;
    uc1.v[VarType::ChgStnSellVc05 as usize].v = 0.05;
    uc1.v[VarType::MvPowSatTrVc06 as usize].v = 0.05;
    uc1.v[VarType::PowSolarVc07 as usize].v = 0.15;
    uc1.v[VarType::MvVsppVc08 as usize].v = 0.05;
    uc1.v[VarType::HvSppVc09 as usize].v = 0.05;
    uc1.v[VarType::UnbalPowVc12 as usize].v = 0.10;
    uc1.v[VarType::CntUnbalPowVc13 as usize].v = 0.05;

    let mut uc2 = PeaAssVar::from(0u64);
    uc2.vt02 = 0.05;
    uc2.vt10 = 0.10;
    uc2.vc01 = 0.05;
    uc2.vc03 = 0.05;
    ...
    uc2.vc12 = 0.05;
    uc2.vc13 = 0.05;
    uc2.v[VarType::SmallSellTrVt02 as usize].v = 0.05;
    uc2.v[VarType::LargeSellTrVt10 as usize].v = 0.10;
    uc2.v[VarType::NoHmChgEvTrVc01 as usize].v = 0.05;
    uc2.v[VarType::CntLvPowSatTrVc03 as usize].v = 0.05;
    uc2.v[VarType::ChgStnCapVc04 as usize].v = 0.10;
    uc2.v[VarType::ChgStnSellVc05 as usize].v = 0.10;
    uc2.v[VarType::MvPowSatTrVc06 as usize].v = 0.15;
    uc2.v[VarType::PowSolarVc07 as usize].v = 0.05;
    uc2.v[VarType::MvVsppVc08 as usize].v = 0.15;
    uc2.v[VarType::HvSppVc09 as usize].v = 0.10;
    uc2.v[VarType::UnbalPowVc12 as usize].v = 0.05;
    uc2.v[VarType::CntUnbalPowVc13 as usize].v = 0.05;
    ...
    */
    ...
    let mut uc3 = PeaAssVar::from(0u64);
    uc3.vt02 = 0.10;
    uc3.vt10 = 0.05;
    uc3.vc01 = 0.15;
    uc3.vc03 = 0.15;
    ...
    uc3.vc12 = 0.10;
    uc3.vc13 = 0.05;
    uc3.v[VarType::SmallSellTrVt02 as usize].v = 0.10;
    uc3.v[VarType::LargeSellTrVt10 as usize].v = 0.05;
    uc3.v[VarType::NoHmChgEvTrVc01 as usize].v = 0.15;
    uc3.v[VarType::CntLvPowSatTrVc03 as usize].v = 0.15;
    uc3.v[VarType::ChgStnCapVc04 as usize].v = 0.05;
    uc3.v[VarType::ChgStnSellVc05 as usize].v = 0.05;
    uc3.v[VarType::MvPowSatTrVc06 as usize].v = 0.05;
    uc3.v[VarType::PowSolarVc07 as usize].v = 0.15;
    uc3.v[VarType::MvVsppVc08 as usize].v = 0.05;
    uc3.v[VarType::HvSppVc09 as usize].v = 0.05;
    uc3.v[VarType::UnbalPowVc12 as usize].v = 0.10;
    uc3.v[VarType::CntUnbalPowVc13 as usize].v = 0.05;
    ...
    for id in aids {
        ...
        for pid in pids {
            ...
            for sid in sids {
                ...
                let a = write_trn_ass_01(&v_tras_nor, &format!("{dnm}/{sid}-no2.txt"))?;
                let b = write_trn_ass_010(&v_tras_nor, &format!("{dnm}/{sid}-no20.txt"))?;
                println!("=====================================  {}", a == b);
                ...
                let a = write_trn_ass_01(&v_uc1, &format!("{dnm}/{sid}-uc1.txt"))?;
                let b = write_trn_ass_010(&v_uc1, &format!("{dnm}/{sid}-uc10.txt"))?;
                println!("=====================================  {}", a == b);
                ...
                let a = write_trn_ass_01(&v_uc2, &format!("{dnm}/{sid}-uc2.txt"))?;
                let b = write_trn_ass_010(&v_uc2, &format!("{dnm}/{sid}-uc20.txt"))?;
                println!("=====================================  {}", a == b);
                ...
                let a = write_trn_ass_01(&v_uc3, &format!("{dnm}/{sid}-uc3.txt"))?;
                let b = write_trn_ass_010(&v_uc3, &format!("{dnm}/{sid}-uc30.txt"))?;
                println!("=====================================  {}", a == b);

                let bin: Vec<u8> =
                    bincode::encode_to_vec(&v_tras_raw, bincode::config::standard()).unwrap();
                std::fs::write(format!("{dnm}/{sid}-rw3.bin"), bin).unwrap();
                let a = write_trn_ass_01(&v_tras_raw, &format!("{dnm}/{sid}-rw3.txt"))?;
                let b = write_trn_ass_010(&v_tras_raw, &format!("{dnm}/{sid}-rw30.txt"))?;
                println!("=====================================  {}", a == b);
            }
        }
    }
...
fn write_trn_ass_010(tr_as: &Vec<PeaAssVar>, fnm: &str) -> Result<String, Box<dyn Error>> {
    let mut x = String::new();
    use std::fmt::Write;
    for t in tr_as {
        t._a("y:");
        ...
        write!(x, "\t{}", t.v[VarType::GppVp02 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::MaxPosPowSubVs01 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::MaxNegPowSubVs02 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::VsppMvVs03 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::SppHvVs04 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::BigLotMvVs05 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::BigLotHvVs06 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::SubPowCapVs07 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::MaxPosPowFeederVf01 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::MaxNegPowFeederVf02 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::MaxPosDiffFeederVf03 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::MaxNegDiffFeederVf04 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::NoMeterTransVt01 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::SmallSellTrVt02 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::ChgStnCapTrVt03 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::ChgStnSellTrVt04 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::PwCapTriVt05 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::ZoneTrVt06 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::PopTrVt07 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::UnbalPowTrVt08 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::PkPowTrVt09 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::LargeSellTrVt10 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::AllNoMeterTrVt11 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::NoTrVt12 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::NoHmChgEvTrVc01 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::LvPowSatTrVc02 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::CntLvPowSatTrVc03 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::ChgStnCapVc04 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::ChgStnSellVc05 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::MvPowSatTrVc06 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::PowSolarVc07 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::MvVsppVc08 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::HvSppVc09 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::SmallSellVc10 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::LargeSellVc11 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::UnbalPowVc12 as usize].v)?;
        write!(x, "\t{}", t.v[VarType::CntUnbalPowVc13 as usize].v)?;
        writeln!(x)?;
    }
    println!("        ===== write to {fnm}");
    let b = x.as_bytes();
...
fn write_trn_ass_020(tr_as: &Vec<PeaAssVar>, fnm: &str) -> Result<String, Box<dyn Error>> {
    let mut x = String::new();
    use std::fmt::Write;
    for t in tr_as {
        write!(x, "{}", t.sbid)?;
...
pub fn c01_chk_03() -> Result<(), Box<dyn Error>> {
    ...
    let a = write_trn_ass_02(&v_sbas, &format!("{dnm}/000-sbrw.txt"))?;
    let b = write_trn_ass_020(&v_sbas, &format!("{dnm}/000-sbrw0.txt"))?;
    println!("=====================================  {}", a == b);
    ...
    let a = write_trn_ass_02(&v_sbas, &format!("{dnm}/000-sbno.txt"))?;
    let b = write_trn_ass_020(&v_sbas, &format!("{dnm}/000-sbno0.txt"))?;
    println!("=====================================  {}", a == b);
